...
// Template for the component content
...
// Function to create multiple files (P4d.js to P21d.js)
const createMultipleFiles = (start, end) => {
    for (let i = start; i <= end; i++) {
        const componentName = `P${i}dd`;
        const fileName = `pp${i}.js`;
        const fileContent = componentTemplate.replace(/PXdd/g, componentName);
...
// Create files from P4d.js to P21d.js
createMultipleFiles(1, 30);
