  ...
  const P2d = () => {
    return (
        <div>
            <Navbarr />
            <div>
                <h1 className="head1">Cr Carbon Steel</h1>
                <div className="bb">
                    <div className="box">
                ...
                <div className="a11">
                    ...
                    <p className="content" style={{ fontSize: '100%' }}>
                        1. The cold-rolled coil products are accurate in size, uniform in thickness, and the thickness difference of the coils generally does not exceed 0.01-0.03 mm or less, which can meet the requirements of high-precision tolerances.<br />
                        2. It is possible to obtain extremely thin strips that cannot be produced by hot rolling (up to 0.001 mm or less).<br />
                        3. The surface quality of cold-rolled products is superior, there are no defects such as pitting, hot-pressed iron oxide, etc., which are often found in hot-rolled coils, and coils of different surface roughness (glossy or hemp) can be produced according to user requirements. Rough surface, etc., to facilitate the processing of the next process.<br />
                        4. The cold rolled plate has good mechanical properties and process properties (such as higher strength, lower yield limit, good deep drawability, etc.).<br />
